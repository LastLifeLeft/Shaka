// Configuration (set by rhythm engine)
note_config = undefined;

// References (initialized in note_init)
note_data = undefined;
highway = undefined;
rhythm_engine = noone;

// Timing (for time-based positioning)
spawn_time_ms = 0;           // When this note was spawned (song time)
hit_time_ms = 0;             // When this note should be hit (song time)
