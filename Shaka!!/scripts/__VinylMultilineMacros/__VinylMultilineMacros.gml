...
#macro __VINYL_VOICE_PITCH_LxM	  (__pitchLocal*__pitchMix)
#macro __VINYL_VOICE_PITCH_SxLxM	(__pitchSound*__pitchLocal*__pitchMix)
#macro __VINYL_VOICE_PITCH_SxPxLxM  (__pitchSound*__pitchPattern*__pitchLocal*__pitchMix)
#macro __VINYL_VOICE_PITCH_PxLxM	(__pitchPattern*__pitchLocal*__pitchMix)