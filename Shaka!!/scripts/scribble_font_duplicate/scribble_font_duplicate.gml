...
function scribble_font_duplicate(_old, _new)
{
	...
	var _new_font_data = new __scribble_class_font(_new, ds_grid_width(_old_font_data.__glyph_data_grid), _old_font_data.__render_type, false, _old_font_data.__texels_valid);
