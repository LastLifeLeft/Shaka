...
function gameframe_update() {
	...
	if (!point_in_rectangle(_mx, _my, __buttons_x, 0, _gw - ((gameframe_isMaximized_hx ? 0 : _resizePadding)), __titleHeight)) {
	...
	gameframe_button_update(__buttons_x, 0, __titleHeight, _mx, _my);
...
function gameframe_button_get_combined_offset(_windowWidth) {
	...
	/// @returns {int}
	return _windowWidth - gameframe_button_get_combined_width();
}
...
function gameframe_drag_update() {
	...
	switch (gameframe_drag_flags) {
		...
		case 32:
			...
			break;
		case 1: // Left
			var __x = min(__mx - (gameframe_drag_mx - gameframe_drag_left),  gameframe_drag_right - gameframe_minimum_width);
			
			window_set_rectangle(__x, gameframe_drag_top, gameframe_drag_right - __x, gameframe_drag_bottom - gameframe_drag_top);
			break;
		case 2: // Top
			var __y = min(__my - (gameframe_drag_my - gameframe_drag_top),  gameframe_drag_bottom - gameframe_minimum_height);
			
			window_set_rectangle(gameframe_drag_left, __y, gameframe_drag_right - gameframe_drag_left, gameframe_drag_bottom - __y);
			break;
		case 4: window_set_rectangle(gameframe_drag_left, gameframe_drag_top, max(gameframe_drag_right - gameframe_drag_left - gameframe_drag_mx + __mx, gameframe_minimum_width), gameframe_drag_bottom - gameframe_drag_top); break;
		case 8: window_set_rectangle(gameframe_drag_left, gameframe_drag_top, gameframe_drag_right - gameframe_drag_left, max(gameframe_drag_bottom - gameframe_drag_top - gameframe_drag_my + __my, gameframe_minimum_height)); break;
		case 3: // Top right
			var __x = min(__mx - (gameframe_drag_mx - gameframe_drag_left),  gameframe_drag_right - gameframe_minimum_width);
			var __y = min(__my - (gameframe_drag_my - gameframe_drag_top),  gameframe_drag_bottom - gameframe_minimum_height);
			
			window_set_rectangle(__x, __y, max(gameframe_drag_right - __x, gameframe_minimum_width), max(gameframe_drag_bottom - __y, gameframe_minimum_height));
			break;
		case 9:
			var __x = min(__mx - (gameframe_drag_mx - gameframe_drag_left),  gameframe_drag_right - gameframe_minimum_width);
			window_set_rectangle(__x, gameframe_drag_top, gameframe_drag_right - __x, max(gameframe_drag_bottom - gameframe_drag_top - gameframe_drag_my + __my, gameframe_minimum_height));
			break;
		case 6:
			var __y = min(__my - (gameframe_drag_my - gameframe_drag_top),  gameframe_drag_bottom - gameframe_minimum_height);
			window_set_rectangle(gameframe_drag_left, __y, max(gameframe_drag_right - gameframe_drag_left - gameframe_drag_mx + __mx, gameframe_minimum_width), gameframe_drag_bottom - __y);
			break;
		case 12: window_set_rectangle(gameframe_drag_left, gameframe_drag_top, max(gameframe_drag_right - gameframe_drag_left - gameframe_drag_mx + __mx, gameframe_minimum_width), max(gameframe_drag_bottom - gameframe_drag_top - gameframe_drag_my + __my, gameframe_minimum_height)); break;
	}
}
...
function gameframe_draw() {
	...
	var __buttons_x = gameframe_button_get_combined_offset(_gw);
	gameframe_caption_draw_background(0, 0, _gw, __titlebarHeight, __buttons_x);
	gameframe_caption_draw_text(0, 0, __buttons_x, __titlebarHeight);
	gameframe_button_draw(__buttons_x, 0, __titlebarHeight);
...
// gameframe_size:
globalvar gameframe_minimum_width;
gameframe_minimum_width = 1;
globalvar gameframe_minimum_height;
gameframe_minimum_height = 1;
// gameframe_button:
...
gameframe_spr_caption = spr_gameframe_caption;
globalvar gameframe_spr_buttons; /// @is {sprite}
gameframe_spr_buttons = spr_gameframe_buttons;
globalvar gameframe_spr_pixel; /// @is {sprite}
gameframe_spr_pixel = spr_gameframe_pixel;
